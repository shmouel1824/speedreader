...
class Quiz(models.Model):
    ...
    # ← choices property belongs HERE on Quiz
    @property
    def choices(self):
        return [
            ('A', self.choice_a),
...
class UserSession(models.Model):
    ...
    time_spent   = models.PositiveIntegerField(default=0)
    chunk_size   = models.PositiveIntegerField(default=1)
    reading_mode = models.CharField(max_length=20, default='highlight') # ← new
    completed    = models.BooleanField(default=False)
    created_at   = models.DateTimeField(auto_now_add=True)
...
class UserProfile(models.Model):
    ...
    total_sessions  = models.PositiveIntegerField(default=0)
    average_score   = models.FloatField(default=0.0)
    current_streak  = models.PositiveIntegerField(default=0)   # ← new
    longest_streak  = models.PositiveIntegerField(default=0)   # ← new
    last_session_date = models.DateField(null=True, blank=True) # ← new
    created_at      = models.DateTimeField(auto_now_add=True)
...
# ─────────────────────────────────────────
# 13. SPEED READING Q&A (knowledge base)
# ─────────────────────────────────────────
...
# ─────────────────────────────────────────
# 14. ASSISTANT MESSAGE (chat history)
# ─────────────────────────────────────────
